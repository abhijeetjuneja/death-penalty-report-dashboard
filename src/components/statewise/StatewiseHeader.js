                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="content pb-1">
                                <p class="desktop-filter"><b>Statewise Distribution (Click marker to Select State)</b> &nbsp;&nbsp;
                                ...
                                <div class="mobile-filter"><p><b>Statewise Distribution (Click marker to Select State)</b> &nbsp;&nbsp;
                                {currentState != null ? <button type="button" class="btn btn-sm btn-secondary" onClick={() => setCurrentState(null)}>Show All</button>: null}
                                &nbsp;&nbsp;&nbsp;&nbsp;</p>
                                    <p>Offense: &nbsp;
                                    <select name="natureOfOffenceFilter" onChange={onChange} value={natureOfOffenceFilter}>
